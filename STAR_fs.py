...
def main(args):
    ...
    if args.phase == 'train':
        ...
        for epoch in range(args.total_epochs):
            ...
            loss_list = []
            metrics = {
                        'total': 0.0, 'rec': 0.0, 'coh': 0.0, 'steps': 0,
                    }
            ...
            if (epoch + 1) % args.save_interval == 0:
                ...
                for item, test_data in zip(args.item_list, test_data_list):
                    test_dataloader = torch.utils.data.DataLoader(test_data, batch_size=args.batch_size, shuffle=False,
                                                                  num_workers=4)
                    results = evaluation_batch(model, args.vis_enable, test_dataloader, device, max_ratio=0.01, resize_mask=256)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='')
        # dataset info
    parser.add_argument('--dataset', type=str, default=r'Real-IAD') # 'MVTec-AD-2' or MVTec-AD' or 'VisA' or 'Real-IAD'
    parser.add_argument('--data_path', type=str, default='../data/realiad') # Replace it with your path.
    
    # save info
    parser.add_argument('--save_dir', type=str, default='./saved_results')
    parser.add_argument('--save_name', type=str, default='STAR_Few-Shot')
    ...
    parser.add_argument('--shot', type=int, default=4) # Number of samples
        ...
        # training info
    parser.add_argument('--vis_enable', type=bool, default=False)
